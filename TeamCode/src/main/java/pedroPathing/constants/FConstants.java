...
public class FConstants {
    static {
        ...
        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.01,0,0.0001,0);
        ...
        FollowerConstants.drivePIDFCoefficients.setCoefficients(0.01,0,0.0001,0,0);
